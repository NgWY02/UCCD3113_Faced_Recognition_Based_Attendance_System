    ...
    <>
      ...
      <section id="architecture" className="architecture py-5">
        <div className="container mt-5">
          ...
          <img
            src={require("../assets/architecture_diagram.jpg")}
          ...
          <div className="row g-4">
            {[
              ...
              },
              {
                title: "AWS Lambda",
                description:
                  "Serverless backend logic for image comparison and database operations.",
                link: "https://docs.aws.amazon.com/lambda/",
              },
              {
                title: "Amazon S3",
                description:
                  "Stores uploaded student images and attendance records.",
                link: "https://docs.aws.amazon.com/s3/",
              },
              {
                title: "Amazon Rekognition",
                description:
                  "Facial recognition for authentication and student registration.",
                link: "https://docs.aws.amazon.com/rekognition/",
              },
              {
                title: "Amazon DynamoDB",
                description:
                  "NoSQL database storing face ID and student information.",
                link: "https://docs.aws.amazon.com/dynamodb/",
              },
              {
                title: "Amazon Athena",
                description:
                  "SQL-based querying of attendance records stored in S3.",
